...
DEFAULT_QUESTIONNAIRE_CONFIG: dict = {
    "questionnaireSections": [
        ...
        _questionnaire_section(
            ...
            "Architecture Type",
            "Dominant architecture style(s) for this project. Select all that apply.",
            [
                _section_field(
                    "architectureType",
                    "Which architecture types apply to this project?",
                    control="multiselect",
                    options=[
                        {"label": "Web application", "value": "web_application"},
                        {"label": "Data platform", "value": "data_platform"},
                        {"label": "AI / ML system", "value": "ai_ml_system"},
                        {"label": "LLM / RAG system", "value": "llm_rag_system"},
                        {"label": "Identity / IAM integration", "value": "identity_iam_integration"},
                        {"label": "Event-driven system", "value": "event_driven_system"},
                        {"label": "Cross-border / multi-region platform", "value": "cross_border_multi_region"},
                        {"label": "SaaS integration", "value": "saas_integration"},
