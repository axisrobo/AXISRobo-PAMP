...
TABLE_ORDER = [
    ...
    "pamp_request",
    "pamp_request_process_log",
    "pamp_request_attachment",
    "pamp_meetings",
    "pamp_actions",
    "pamp_bigea_team_members",
    "pamp_arch_ai_check",
    "pamp_arch_ai_check_interaction",
    "pamp_arch_ai_check_app",
    "tech_key_stack_item",
...
TABLE_DESCRIPTIONS = {
    ...
    "pamp_request": "Architecture review requests - the core entity for the EA review workflow.",
    "pamp_request_process_log": "Process log tracking state transitions and workflow steps per request.",
    "pamp_request_attachment": "Attachments/documents uploaded for architecture review requests.",
    "pamp_meetings": "Review meeting records linked to projects/requests.",
    "pamp_actions": "Action items from review meetings linked to requests.",
    "pamp_bigea_team_members": "EA team member directory (itcode, name, org hierarchy).",
    "pamp_arch_ai_check": "AI review check results against architecture diagrams.",
    "pamp_arch_ai_check_interaction": "AI analysis of interactions between applications in a check.",
    "pamp_arch_ai_check_app": "Applications referenced in AI architecture checks.",
    ...
    "pamp_project": "Projects tracked in the project management module.",
    "pamp_team_member": "Team members assigned to projects.",
    "pamp_project_app": "Applications associated with projects.",
    "resource_pool": "Resource directory (itcode, name, email, org hierarchy) for autocomplete.",
    "pamp_audit_log": "RBAC audit log recording all access decisions (allow/deny) with user, resource, action.",
    "pamp_file_storage": "Binary file storage (S3 alternative) keyed by path.",
