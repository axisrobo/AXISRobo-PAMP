...
TABLE_DESCRIPTIONS = {
    ...
    "avdm_concern_artifact_mapping": "Maps PACT concerns to recommended artifacts with status (Mandatory/Recommended/Optional/Not Required).",
    "avdm_viewpoint": "Architecture viewpoint definitions with L/P classification, S/B classification, purpose, examples, audience.",
    "avdm_viewpoint_concern_mapping": "Maps viewpoints to their associated PACT concerns.",
